            ...
            <nav className="flex items-center justify-between">
              ...
              >
                <div className="min-w-[55px]">
                  <Image
                    src={isGeneral ? '/evergreen.svg' : '/logo.svg'}
                    width={55}
                    height={53}
                    alt="&Evergreen Logo"
                  />
                ...
                >
                  {isGeneral ? (
                    <div className="text-[24px] font-bold">&Evergreen</div>
                  ) : (
                    'Gitroom'
                  )}
                </div>
                  ...
                  <>
                    <div className="text-center mb-[20px] text-xl [@media(max-width:1024px)]:text-xl">
                      <h1 className="text-3xl [@media(max-width:1024px)]:text-xl">
                        {t(
                          'join_1000_entrepreneurs_who_use_evergreen',
                          'Join 1000+ Entrepreneurs Who Use &Evergreen'
                        )}
                        <br />
                        {t(
